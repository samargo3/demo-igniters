...
// Write to CSV file
const csvHeader = 'FirstName,LastName,Company,Email,Phone,Industry,LeadSource,Status,Title,State,City,Country,AnnualRevenue,NumberOfEmployees,Description,CreatedDate,LastActivityDate\n';
...
const outputPath = path.join(__dirname, '..', 'data', 'leads-simple.csv');
...
const avgRevenue = leads.reduce((sum, lead) => sum + lead.AnnualRevenue, 0) / leads.length;
