...
function generateLeadData() {
  ...
  // Generate realistic company size and revenue
  const companySize = getRandomElement(['1-10', '11-50', '51-200', '201-1000', '1001-5000', '5001+']);
  const annualRevenue = getRandomElement(['$0-$1M', '$1M-$10M', '$10M-$50M', '$50M-$100M', '$100M+']);
  
  // Generate realistic lead scores and other fields
  ...
  const lastActivityDate = getRandomDate(createdDate, new Date());
...
// Generate leads
console.log(`Generating ${NUM_LEADS} leads...`);
...
// Write to CSV file
const csvHeader = 'FirstName,LastName,Company,Email,Phone,Industry,LeadSource,Status,Title,State,City,Country,Company_Size__c,AnnualRevenue,NumberOfEmployees,Lead_Score__c,Description,CreatedDate,LastActivityDate\n';
...
const outputPath = path.join(__dirname, '..', 'data', 'leads.csv');
fs.writeFileSync(outputPath, csvContent);

console.log(`\n✅ Generated ${NUM_LEADS} leads and saved to ${outputPath}`);
console.log('\n📊 Lead Distribution:');
